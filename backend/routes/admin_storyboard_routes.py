...
async def _stage_video_generation(order: dict, pipeline_cfg: dict,
    ...
    for sp in scene_plans:
        ...
        scene_clips.append({
            ...
            "error":            c.get("error"),
            "import_status":    c.get("import_status") or ("imported" if c.get("video_url") else None),
            "fallback_reason":  c.get("fallback_reason"),
            "submit_state":     c.get("submit_state"),
            "submitted_at":     c.get("submitted_at"),
            "imported_at":      c.get("imported_at"),
            "manually_recovered": bool(c.get("manually_recovered")),
